        ...
        <ul class="nav page-navigation">
            ...
            <li class="nav-item <?php if(isset($_GET['order_new'])){echo "active";}elseif(isset($_GET['order_old'])){echo "active";} ?>">
                ...
                <div class="submenu">
                    <ul>
                        <li class="nav-item"><a class="nav-link" href="index.?order_new">Generate Order</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.?order_old">Modify Orders</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item <?php if(isset($_GET['reports'])){echo "active";} ?>">
                <a href="index.?reports" class="nav-link reports">
